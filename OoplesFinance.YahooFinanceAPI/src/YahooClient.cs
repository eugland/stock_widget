...
public class YahooClient {
    ...
    /// <returns></returns>
    public async Task<IEnumerable<HistoricalChartInfo>> GetHistoricalDataAsync(string symbol,
        DataFrequency dataFrequency, DateTime startDate) {
    ...
    public async Task<IEnumerable<HistoricalChartInfo>> GetHistoricalDataAsync(string symbol,
        ...
        return new HistoricalHelper().ParseYahooJsonData<HistoricalChartInfo>(await DownloadRawCsvDataAsync(symbol,
            DataType.HistoricalPrices, dataFrequency, startDate, endDate, includeAdjustedClose));
    }
    ...
    public async Task<HistoricalFullData> GetAllHistoricalDataAsync(string symbol, DataFrequency dataFrequency,
        DateTime startDate, DateTime? endDate, bool includeAdjustedClose) {
        return new AllHistoricalHelper().ParseYahooJsonData<HistoricalFullData>(await DownloadRawCsvDataAsync(symbol,
            DataType.All, dataFrequency, startDate, endDate,
    ...
    public async Task<IEnumerable<DividendResult>> GetDividendDataAsync(string symbol, DataFrequency dataFrequency,
        DateTime startDate, DateTime? endDate, bool includeAdjustedClose) {
        return new DividendHelper().ParseYahooJsonData<DividendResult>(await DownloadRawCsvDataAsync(symbol,
            DataType.Dividends, dataFrequency, startDate, endDate, includeAdjustedClose));
    }
    ...
    public async Task<IEnumerable<StockSplitResult>> GetStockSplitDataAsync(string symbol, DataFrequency dataFrequency,
        DateTime startDate, DateTime? endDate, bool includeAdjustedClose) {
        return new StockSplitHelper().ParseYahooJsonData<StockSplitResult>(await DownloadRawCsvDataAsync(symbol,
            DataType.StockSplits, dataFrequency, startDate, endDate, includeAdjustedClose));
    }
    ...
    public async Task<IEnumerable<Result>> GetCapitalGainDataAsync(string symbol, DataFrequency dataFrequency,
        DateTime startDate, DateTime? endDate, bool includeAdjustedClose) {
        return new CapitalGainHelper().ParseYahooJsonData<Result>(await DownloadRawCsvDataAsync(symbol,
            DataType.CapitalGains, dataFrequency, startDate, endDate, includeAdjustedClose));
    }
    ...
    public async Task<IEnumerable<RecommendedSymbol>> GetStockRecommendationsAsync(string symbol) {
        return new RecommendationHelper().ParseYahooJsonData<RecommendedSymbol>(
            await DownloadRecommendDataAsync(symbol));
    }
    ...
    public async Task<KeyStatistics> GetKeyStatisticsAsync(string symbol) {
        return new KeyStatisticsHelper()
            .ParseYahooJsonData<KeyStatistics>(await DownloadStatsDataAsync(symbol, Country, Language,
                YahooModule.KeyStatistics)).First();
    }
    ...
    public async Task<SummaryDetail> GetSummaryDetailsAsync(string symbol) {
        return new SummaryDetailsHelper()
            .ParseYahooJsonData<SummaryDetail>(await DownloadStatsDataAsync(symbol, Country, Language,
                YahooModule.SummaryDetails)).First();
    }
    ...
    public async Task<IEnumerable<InsiderHolder>> GetInsiderHoldersAsync(string symbol) {
        return new InsiderHolderHelper().ParseYahooJsonData<InsiderHolder>(
            await DownloadStatsDataAsync(symbol, Country, Language, YahooModule.InsiderHolders));
    }
    ...
    public async Task<IEnumerable<Transaction>> GetInsiderTransactionsAsync(string symbol) {
        return new InsiderTransactionHelper().ParseYahooJsonData<Transaction>(
            await DownloadStatsDataAsync(symbol, Country, Language, YahooModule.InsiderTransactions));
    }
    ...
    public async Task<FinancialData> GetFinancialDataAsync(string symbol) {
        return new FinancialDataHelper()
            .ParseYahooJsonData<FinancialData>(await DownloadStatsDataAsync(symbol, Country, Language,
                YahooModule.FinancialData)).First();
    }
    ...
    public async Task<IEnumerable<OwnershipList>> GetInstitutionOwnershipAsync(string symbol) {
        return new InstitutionOwnershipHelper().ParseYahooJsonData<OwnershipList>(
            await DownloadStatsDataAsync(symbol, Country, Language, YahooModule.InstitutionOwnership));
    }
    ...
    public async Task<IEnumerable<OwnershipList>> GetFundOwnershipAsync(string symbol) {
        return new FundOwnershipHelper().ParseYahooJsonData<OwnershipList>(
            await DownloadStatsDataAsync(symbol, Country, Language, YahooModule.FundOwnership));
    }
    ...
    public async Task<IEnumerable<object>> GetMajorDirectHoldersAsync(string symbol) {
        return new MajorDirectHoldersHelper().ParseYahooJsonData<object>(
            await DownloadStatsDataAsync(symbol, Country, Language, YahooModule.MajorDirectHolders));
    }
    ...
    public async Task<IEnumerable<Filing>> GetSecFilingsAsync(string symbol) {
        return new SecFilingsHelper().ParseYahooJsonData<Filing>(
            await DownloadStatsDataAsync(symbol, Country, Language, YahooModule.SecFilings));
    }
    ...
    public async Task<EsgScores> GetEsgScoresAsync(string symbol) {
        return new EsgScoresHelper()
            .ParseYahooJsonData<EsgScores>(await DownloadStatsDataAsync(symbol, Country, Language,
                YahooModule.EsgScores)).First();
    }
    ...
    public async Task<IEnumerable<Trend>> GetRecommendationTrendAsync(string symbol) {
        return new RecommendationTrendHelper().ParseYahooJsonData<Trend>(
            await DownloadStatsDataAsync(symbol, Country, Language, YahooModule.RecommendationTrend));
    }
    ...
    public async Task<IndexTrend> GetIndexTrendAsync(string symbol) {
        return new IndexTrendHelper()
            .ParseYahooJsonData<IndexTrend>(await DownloadStatsDataAsync(symbol, Country, Language,
                YahooModule.IndexTrend)).First();
    }
    ...
    public async Task<SectorTrend> GetSectorTrendAsync(string symbol) {
        return new SectorTrendHelper()
            .ParseYahooJsonData<SectorTrend>(await DownloadStatsDataAsync(symbol, Country, Language,
                YahooModule.SectorTrend)).First();
    }
    ...
    public async Task<IEnumerable<EarningsTrendInfo>> GetEarningsTrendAsync(string symbol) {
        return new EarningsTrendHelper().ParseYahooJsonData<EarningsTrendInfo>(
            await DownloadStatsDataAsync(symbol, Country, Language, YahooModule.EarningsTrend));
    }
    ...
    public async Task<AssetProfile> GetAssetProfileAsync(string symbol) {
        return new AssetProfileHelper()
            .ParseYahooJsonData<AssetProfile>(await DownloadStatsDataAsync(symbol, Country, Language,
                YahooModule.AssetProfile)).First();
    }
    ...
    public async Task<FundProfile> GetFundProfileAsync(string symbol) {
        return new FundProfileHelper()
            .ParseYahooJsonData<FundProfile>(await DownloadStatsDataAsync(symbol, Country, Language,
                YahooModule.FundProfile)).First();
    }
    ...
    public async Task<IEnumerable<CalendarEvents>> GetCalendarEventsAsync(string symbol) {
        return new CalendarEventsHelper().ParseYahooJsonData<CalendarEvents>(
            await DownloadStatsDataAsync(symbol, Country, Language, YahooModule.CalendarEvents));
    }
    ...
    public async Task<IEnumerable<EarningsInfo>> GetEarningsAsync(string symbol) {
        return new EarningsHelper().ParseYahooJsonData<EarningsInfo>(
            await DownloadStatsDataAsync(symbol, Country, Language, YahooModule.Earnings));
    }
    ...
    public async Task<IEnumerable<EarningsHistoryInfo>> GetEarningsHistoryAsync(string symbol) {
        return new EarningsHistoryHelper().ParseYahooJsonData<EarningsHistoryInfo>(
            await DownloadStatsDataAsync(symbol, Country, Language, YahooModule.EarningsHistory));
    }
    ...
    public async Task<QuoteType> GetQuoteTypeAsync(string symbol) {
        return new QuoteTypeHelper()
            .ParseYahooJsonData<QuoteType>(await DownloadStatsDataAsync(symbol, Country, Language,
                YahooModule.QuoteType)).First();
    }
    ...
    public async Task<Price> GetPriceInfoAsync(string symbol) {
        return new PriceHelper()
            .ParseYahooJsonData<Price>(await DownloadStatsDataAsync(symbol, Country, Language, YahooModule.Price))
            .First();
    }
    ...
    public async Task<ChartInfo> GetChartInfoAsync(string symbol, TimeRange timeRange, TimeInterval timeInterval) {
        return new ChartHelper()
            .ParseYahooJsonData<ChartInfo>(await DownloadChartDataAsync(symbol, timeRange, timeInterval)).First();
    }

    public async Task<ChartRoot> GetChartResults(string symbol, TimeRange timeRange, TimeInterval timeInterval) {
        var ans = await DownloadChartDataAsync(symbol, timeRange, timeInterval);
        return JsonConvert.DeserializeObject<ChartRoot>(ans);
    }
    ...
    public async Task<SparkInfo> GetSparkChartInfoAsync(string symbol, TimeRange timeRange, TimeInterval timeInterval) {
        return new SparkChartHelper()
            .ParseYahooJsonData<SparkInfo>(await DownloadSparkChartDataAsync(symbol, timeRange, timeInterval)).First();
    }
    ...
    /// <param name="timeInterval"></param>
    /// <returns></returns>
    public async Task<IEnumerable<SparkInfo>> GetSparkChartInfoAsync(IEnumerable<string> symbols, TimeRange timeRange,
        TimeInterval timeInterval) {
        return new SparkChartHelper().ParseYahooJsonData<SparkInfo>(
            await DownloadSparkChartDataAsync(symbols, timeRange, timeInterval));
    }
    ...
    public async Task<RealTimeQuoteResult> GetRealTimeQuotesAsync(string symbol) {
        return new RealTimeQuoteHelper()
            .ParseYahooJsonData<RealTimeQuoteResult>(await DownloadRealTimeQuoteDataAsync(symbol, Country, Language))
            .FirstOrDefault() ?? new RealTimeQuoteResult();
    }
    ...
    public async Task<IEnumerable<RealTimeQuoteResult>> GetRealTimeQuotesAsync(IEnumerable<string> symbols) {
        return new RealTimeQuoteHelper().ParseYahooJsonData<RealTimeQuoteResult>(
            await DownloadRealTimeQuoteDataAsync(symbols, Country, Language));
    }
    ...
    public async Task<IEnumerable<MarketSummaryResult>> GetMarketSummaryAsync() {
        return new MarketSummaryHelper().ParseYahooJsonData<MarketSummaryResult>(
            await DownloadMarketSummaryDataAsync(Country, Language));
    }
    ...
    public async Task<IEnumerable<AutoCompleteResult>> GetAutoCompleteInfoAsync(string searchTerm) {
        return new AutoCompleteHelper().ParseYahooJsonData<AutoCompleteResult>(
            await DownloadAutoCompleteDataAsync(searchTerm, Country, Language));
    }
    ...
    public async Task<ScreenerResult> GetTopGainersAsync(int count) {
        return new ScreenerHelper()
            .ParseYahooJsonData<ScreenerResult>(await DownloadScreenerDataAsync(ScreenerType.DayGainers, count))
            .First();
    }
    ...
    public async Task<ScreenerResult> GetTopLosersAsync(int count) {
        return new ScreenerHelper()
            .ParseYahooJsonData<ScreenerResult>(await DownloadScreenerDataAsync(ScreenerType.DayLosers, count)).First();
    }
    ...
    public async Task<ScreenerResult> GetSmallCapGainersAsync(int count) {
        return new ScreenerHelper()
            .ParseYahooJsonData<ScreenerResult>(await DownloadScreenerDataAsync(ScreenerType.SmallCapGainers, count))
            .First();
    }
    ...
    public async Task<ScreenerResult> GetMostActiveStocksAsync(int count) {
        return new ScreenerHelper()
            .ParseYahooJsonData<ScreenerResult>(await DownloadScreenerDataAsync(ScreenerType.MostActives, count))
            .First();
    }
    ...
    public async Task<ScreenerResult> GetAggressiveSmallCapStocksAsync(int count) {
        return new ScreenerHelper()
            .ParseYahooJsonData<ScreenerResult>(
                await DownloadScreenerDataAsync(ScreenerType.AggressiveSmallCaps, count)).First();
    }
    ...
    public async Task<ScreenerResult> GetConservativeForeignFundsAsync(int count) {
        return new ScreenerHelper()
            .ParseYahooJsonData<ScreenerResult>(await DownloadScreenerDataAsync(ScreenerType.ConservativeForeignFunds,
                count)).First();
    }
    ...
    public async Task<ScreenerResult> GetGrowthTechnologyStocksAsync(int count) {
        return new ScreenerHelper()
            .ParseYahooJsonData<ScreenerResult>(await DownloadScreenerDataAsync(ScreenerType.GrowthTechnologyStocks,
                count)).First();
    }
    ...
    public async Task<ScreenerResult> GetHighYieldBondsAsync(int count) {
        return new ScreenerHelper()
            .ParseYahooJsonData<ScreenerResult>(await DownloadScreenerDataAsync(ScreenerType.HighYieldBond, count))
            .First();
    }
    ...
    public async Task<ScreenerResult> GetMostShortedStocksAsync(int count) {
        return new ScreenerHelper()
            .ParseYahooJsonData<ScreenerResult>(await DownloadScreenerDataAsync(ScreenerType.MostShortedStocks, count))
            .First();
    }
    ...
    public async Task<ScreenerResult> GetPortfolioAnchorsAsync(int count) {
        return new ScreenerHelper()
            .ParseYahooJsonData<ScreenerResult>(await DownloadScreenerDataAsync(ScreenerType.PortfolioAnchors, count))
            .First();
    }
    ...
    public async Task<ScreenerResult> GetSolidLargeGrowthFundsAsync(int count) {
        return new ScreenerHelper()
            .ParseYahooJsonData<ScreenerResult>(await DownloadScreenerDataAsync(ScreenerType.SolidLargeGrowthFunds,
                count)).First();
    }
    ...
    public async Task<ScreenerResult> GetSolidMidcapGrowthFundsAsync(int count) {
        return new ScreenerHelper()
            .ParseYahooJsonData<ScreenerResult>(await DownloadScreenerDataAsync(ScreenerType.SolidMidcapGrowthFunds,
                count)).First();
    }
    ...
    public async Task<ScreenerResult> GetTopMutualFundsAsync(int count) {
        return new ScreenerHelper()
            .ParseYahooJsonData<ScreenerResult>(await DownloadScreenerDataAsync(ScreenerType.TopMutualFunds, count))
            .First();
    }
    ...
    public async Task<ScreenerResult> GetUndervaluedGrowthStocksAsync(int count) {
        return new ScreenerHelper()
            .ParseYahooJsonData<ScreenerResult>(await DownloadScreenerDataAsync(ScreenerType.UndervaluedGrowthStocks,
                count)).First();
    }
    ...
    public async Task<ScreenerResult> GetUndervaluedLargeCapStocksAsync(int count) {
        return new ScreenerHelper()
            .ParseYahooJsonData<ScreenerResult>(await DownloadScreenerDataAsync(ScreenerType.UndervaluedLargeCaps,
                count)).First();
    }
    ...
    public async Task<ScreenerResult> GetUndervaluedWideMoatStocksAsync(int count) {
        return new ScreenerHelper()
            .ParseYahooJsonData<ScreenerResult>(await DownloadScreenerDataAsync(ScreenerType.UndervaluedWideMoatStocks,
                count)).First();
    }
    ...
    public async Task<ScreenerResult> GetMorningstarFiveStarStocksAsync(int count) {
        return new ScreenerHelper()
            .ParseYahooJsonData<ScreenerResult>(await DownloadScreenerDataAsync(ScreenerType.MorningstarFiveStarStocks,
                count)).First();
    }
    ...
    public async Task<ScreenerResult> GetStrongUndervaluedStocksAsync(int count) {
        return new ScreenerHelper()
            .ParseYahooJsonData<ScreenerResult>(await DownloadScreenerDataAsync(ScreenerType.StrongUndervaluedStocks,
                count)).First();
    }
    ...
    public async Task<AnalystResult> GetAnalystStrongBuyStocksAsync(int count) {
        return new AnalystHelper()
            .ParseYahooJsonData<AnalystResult>(await DownloadScreenerDataAsync(ScreenerType.AnalystStrongBuyStocks,
                count)).First();
    }
    ...
    public async Task<AnalystResult> GetLatestAnalystUpgradedStocksAsync(int count) {
        return new AnalystHelper()
            .ParseYahooJsonData<AnalystResult>(await DownloadScreenerDataAsync(ScreenerType.LatestAnalystUpgradedStocks,
                count)).First();
    }
    ...
    public async Task<InstitutionResult> GetMostInstitutionallyBoughtLargeCapStocksAsync(int count) {
        return new InstitutionHelper()
            .ParseYahooJsonData<InstitutionResult>(
                await DownloadScreenerDataAsync(ScreenerType.MostInstitutionallyBoughtLargeCapStocks, count)).First();
    }
    ...
    public async Task<InstitutionResult> GetMostInstitutionallyHeldLargeCapStocksAsync(int count) {
        return new InstitutionHelper()
            .ParseYahooJsonData<InstitutionResult>(
                await DownloadScreenerDataAsync(ScreenerType.MostInstitutionallyHeldLargeCapStocks, count)).First();
    }
    ...
    public async Task<InstitutionResult> GetMostInstitutionallySoldLargeCapStocksAsync(int count) {
        return new InstitutionHelper()
            .ParseYahooJsonData<InstitutionResult>(
                await DownloadScreenerDataAsync(ScreenerType.MostInstitutionallySoldLargeCapStocks, count)).First();
    }
    ...
    public async Task<InstitutionResult> GetStocksWithMostInstitutionalBuyersAsync(int count) {
        return new InstitutionHelper()
            .ParseYahooJsonData<InstitutionResult>(
                await DownloadScreenerDataAsync(ScreenerType.StocksWithMostInstitutionalBuyers, count)).First();
    }
    ...
    public async Task<InstitutionResult> GetStocksWithMostInstitutionalSellersAsync(int count) {
        return new InstitutionHelper()
            .ParseYahooJsonData<InstitutionResult>(
                await DownloadScreenerDataAsync(ScreenerType.StocksWithMostInstitutionalSellers, count)).First();
    }
    ...
    public async Task<InstitutionResult> GetStocksMostBoughtByHedgeFundsAsync(int count) {
        return new InstitutionHelper()
            .ParseYahooJsonData<InstitutionResult>(
                await DownloadScreenerDataAsync(ScreenerType.StocksMostBoughtByHedgeFunds, count)).First();
    }
    ...
    public async Task<InstitutionResult> GetStocksMostBoughtByPensionFundsAsync(int count) {
        return new InstitutionHelper()
            .ParseYahooJsonData<InstitutionResult>(
                await DownloadScreenerDataAsync(ScreenerType.StocksMostBoughtByPensionFunds, count)).First();
    }
    ...
    public async Task<InstitutionResult> GetStocksMostBoughtByPrivateEquityAsync(int count) {
        return new InstitutionHelper()
            .ParseYahooJsonData<InstitutionResult>(
                await DownloadScreenerDataAsync(ScreenerType.StocksMostBoughtByPrivateEquity, count)).First();
    }
    ...
    public async Task<InstitutionResult> GetStocksMostBoughtBySovereignWealthFundsAsync(int count) {
        return new InstitutionHelper()
            .ParseYahooJsonData<InstitutionResult>(
                await DownloadScreenerDataAsync(ScreenerType.StocksMostBoughtBySovereignWealthFunds, count)).First();
    }
    ...
    public async Task<StocksOwnedResult> GetTopStocksOwnedByCathieWoodAsync(int count) {
        return new StocksOwnedHelper()
            .ParseYahooJsonData<StocksOwnedResult>(
                await DownloadScreenerDataAsync(ScreenerType.TopStocksOwnedByCathieWood, count)).First();
    }
    ...
    public async Task<StocksOwnedResult> GetTopStocksOwnedByGoldmanSachsAsync(int count) {
        return new StocksOwnedHelper()
            .ParseYahooJsonData<StocksOwnedResult>(
                await DownloadScreenerDataAsync(ScreenerType.TopStocksOwnedByGoldmanSachs, count)).First();
    }
    ...
    public async Task<StocksOwnedResult> GetTopStocksOwnedByWarrenBuffetAsync(int count) {
        return new StocksOwnedHelper()
            .ParseYahooJsonData<StocksOwnedResult>(
                await DownloadScreenerDataAsync(ScreenerType.TopStocksOwnedByWarrenBuffet, count)).First();
    }
    ...
    public async Task<StocksOwnedResult> GetTopStocksOwnedByRayDalioAsync(int count) {
        return new StocksOwnedHelper()
            .ParseYahooJsonData<StocksOwnedResult>(
                await DownloadScreenerDataAsync(ScreenerType.TopStocksOwnedByRayDalio, count)).First();
    }
    ...
    public async Task<TrendingStocksResult> GetTopBearishStocksRightNowAsync(int count) {
        return new TrendingStocksHelper()
            .ParseYahooJsonData<TrendingStocksResult>(
                await DownloadScreenerDataAsync(ScreenerType.BearishStocksRightNow, count)).First();
    }
    ...
    public async Task<TrendingStocksResult> GetTopBullishStocksRightNowAsync(int count) {
        return new TrendingStocksHelper()
            .ParseYahooJsonData<TrendingStocksResult>(
                await DownloadScreenerDataAsync(ScreenerType.BullishStocksRightNow, count)).First();
    }
    ...
    public async Task<TrendingStocksResult> GetTopUpsideBreakoutStocksAsync(int count) {
        return new TrendingStocksHelper()
            .ParseYahooJsonData<TrendingStocksResult>(
                await DownloadScreenerDataAsync(ScreenerType.UpsideBreakoutStocksDaily, count)).First();
    }
}